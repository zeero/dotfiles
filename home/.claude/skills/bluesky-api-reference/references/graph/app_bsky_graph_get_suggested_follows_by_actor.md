# app.bsky.graph.get.suggested.follows.by.actor

Source: https://docs.bsky.app/docs/api/app-bsky-graph-get-suggested-follows-by-actor
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-graph-get-suggested-follows-by-actor\#request "Direct link to Request")

### Query Parameters

**actor** at-identifierrequired

## Responses [​](https://docs.bsky.app/docs/api/app-bsky-graph-get-suggested-follows-by-actor\#responses "Direct link to Responses")
