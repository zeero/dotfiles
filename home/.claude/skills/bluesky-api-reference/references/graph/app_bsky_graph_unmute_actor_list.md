# app.bsky.graph.unmute.actor.list

Source: https://docs.bsky.app/docs/api/app-bsky-graph-unmute-actor-list
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-graph-unmute-actor-list\#request "Direct link to Request")
...
## Responses [​](https://docs.bsky.app/docs/api/app-bsky-graph-unmute-actor-list\#responses "Direct link to Responses")
