# app.bsky.graph.get.lists.with.membership

Source: https://docs.bsky.app/docs/api/app-bsky-graph-get-lists-with-membership
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-graph-get-lists-with-membership\#request "Direct link to Request")
...
**Possible values:** \[`modlist`, `curatelist`\]

Optional filter by list purpose. If not specified, all supported types are returned.

## Responses [​](https://docs.bsky.app/docs/api/app-bsky-graph-get-lists-with-membership\#responses "Direct link to Responses")
...
**listsWithMembership** object\[\]required
