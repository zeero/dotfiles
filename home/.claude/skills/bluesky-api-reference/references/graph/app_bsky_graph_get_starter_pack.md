# app.bsky.graph.get.starter.pack

Source: https://docs.bsky.app/docs/api/app-bsky-graph-get-starter-pack
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-graph-get-starter-pack\#request "Direct link to Request")

### Query Parameters

**starterPack** at-urirequired

Reference (AT-URI) of the starter pack record.

## Responses [​](https://docs.bsky.app/docs/api/app-bsky-graph-get-starter-pack\#responses "Direct link to Responses")
