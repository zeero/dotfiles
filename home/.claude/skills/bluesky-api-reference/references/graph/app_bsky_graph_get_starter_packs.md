# app.bsky.graph.get.starter.packs

Source: https://docs.bsky.app/docs/api/app-bsky-graph-get-starter-packs
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-graph-get-starter-packs\#request "Direct link to Request")

### Query Parameters

**uris** at-uri\[\]required

**Possible values:**`<= 25`

## Responses [​](https://docs.bsky.app/docs/api/app-bsky-graph-get-starter-packs\#responses "Direct link to Responses")
