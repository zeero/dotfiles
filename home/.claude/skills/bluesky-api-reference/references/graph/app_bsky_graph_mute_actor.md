# app.bsky.graph.mute.actor

Source: https://docs.bsky.app/docs/api/app-bsky-graph-mute-actor
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-graph-mute-actor\#request "Direct link to Request")
...
## Responses [​](https://docs.bsky.app/docs/api/app-bsky-graph-mute-actor\#responses "Direct link to Responses")
