# app.bsky.actor.get.profiles

Source: https://docs.bsky.app/docs/api/app-bsky-actor-get-profiles
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-actor-get-profiles\#request "Direct link to Request")

### Query Parameters

**actors** at-identifier\[\]required

**Possible values:**`<= 25`

## Responses [​](https://docs.bsky.app/docs/api/app-bsky-actor-get-profiles\#responses "Direct link to Responses")
