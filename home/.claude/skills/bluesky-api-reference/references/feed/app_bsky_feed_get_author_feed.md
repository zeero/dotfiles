...
Source: https://docs.bsky.app/docs/api/app-bsky-feed-get-author-feed
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-feed-get-author-feed\#request "Direct link to Request")
...
**Possible values:** \[`posts_with_replies`, `posts_no_replies`, `posts_with_media`, `posts_and_author_threads`, `posts_with_video`\]
...
## Responses [​](https://docs.bsky.app/docs/api/app-bsky-feed-get-author-feed\#responses "Direct link to Responses")
...
Array \[\
\
**post** app.bsky.feed.defs.postViewrequired\
\
**reply** object\
\
**root** objectrequired\
...
**Possible values:** \[`InvalidRequest`, `ExpiredToken`, `InvalidToken`, `BlockedActor`, `BlockedByActor`\]
...
\-\-\-posts\_with\_repliesposts\_no\_repliesposts\_with\_mediaposts\_and\_author\_threadsposts\_with\_video
