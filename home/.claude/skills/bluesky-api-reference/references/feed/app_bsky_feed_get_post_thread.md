...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-feed-get-post-thread\#request "Direct link to Request")
...
## Responses [​](https://docs.bsky.app/docs/api/app-bsky-feed-get-post-thread\#responses "Direct link to Responses")
...
**Possible values:** \[`InvalidRequest`, `ExpiredToken`, `InvalidToken`, `NotFound`\]
