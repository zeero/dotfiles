# app.bsky.feed.get.feed.generators

Source: https://docs.bsky.app/docs/api/app-bsky-feed-get-feed-generators
...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-feed-get-feed-generators\#request "Direct link to Request")

### Query Parameters

**feeds** at-uri\[\]required

## Responses [​](https://docs.bsky.app/docs/api/app-bsky-feed-get-feed-generators\#responses "Direct link to Responses")
