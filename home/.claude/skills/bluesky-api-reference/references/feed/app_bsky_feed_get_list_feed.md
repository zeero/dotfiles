...
## Request [​](https://docs.bsky.app/docs/api/app-bsky-feed-get-list-feed\#request "Direct link to Request")
...
## Responses [​](https://docs.bsky.app/docs/api/app-bsky-feed-get-list-feed\#responses "Direct link to Responses")
...
**Possible values:** \[`InvalidRequest`, `ExpiredToken`, `InvalidToken`, `UnknownList`\]
