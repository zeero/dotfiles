# chat.bsky.convo.update.all.read

Source: https://docs.bsky.app/docs/api/chat-bsky-convo-update-all-read
...
## Request [​](https://docs.bsky.app/docs/api/chat-bsky-convo-update-all-read\#request "Direct link to Request")
...
## Responses [​](https://docs.bsky.app/docs/api/chat-bsky-convo-update-all-read\#responses "Direct link to Responses")
