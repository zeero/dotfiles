# chat.bsky.convo.get.convo

Source: https://docs.bsky.app/docs/api/chat-bsky-convo-get-convo
...
## Request [​](https://docs.bsky.app/docs/api/chat-bsky-convo-get-convo\#request "Direct link to Request")

### Query Parameters

**convoId** stringrequired

## Responses [​](https://docs.bsky.app/docs/api/chat-bsky-convo-get-convo\#responses "Direct link to Responses")
