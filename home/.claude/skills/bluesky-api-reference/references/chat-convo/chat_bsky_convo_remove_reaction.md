# chat.bsky.convo.remove.reaction

Source: https://docs.bsky.app/docs/api/chat-bsky-convo-remove-reaction
...
## Request [​](https://docs.bsky.app/docs/api/chat-bsky-convo-remove-reaction\#request "Direct link to Request")
...
## Responses [​](https://docs.bsky.app/docs/api/chat-bsky-convo-remove-reaction\#responses "Direct link to Responses")
...
**Possible values:** \[`InvalidRequest`, `ExpiredToken`, `InvalidToken`, `ReactionMessageDeleted`, `ReactionInvalidValue`\]
