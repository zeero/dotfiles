# chat.bsky.convo.add.reaction

Source: https://docs.bsky.app/docs/api/chat-bsky-convo-add-reaction
...
## Request [​](https://docs.bsky.app/docs/api/chat-bsky-convo-add-reaction\#request "Direct link to Request")
...
## Responses [​](https://docs.bsky.app/docs/api/chat-bsky-convo-add-reaction\#responses "Direct link to Responses")
...
**Possible values:** \[`InvalidRequest`, `ExpiredToken`, `InvalidToken`, `ReactionMessageDeleted`, `ReactionLimitReached`, `ReactionInvalidValue`\]
