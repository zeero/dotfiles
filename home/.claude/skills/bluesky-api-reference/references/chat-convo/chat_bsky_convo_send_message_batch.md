...
Source: https://docs.bsky.app/docs/api/chat-bsky-convo-send-message-batch
...
## Request [​](https://docs.bsky.app/docs/api/chat-bsky-convo-send-message-batch\#request "Direct link to Request")
...
## Responses [​](https://docs.bsky.app/docs/api/chat-bsky-convo-send-message-batch\#responses "Direct link to Responses")
