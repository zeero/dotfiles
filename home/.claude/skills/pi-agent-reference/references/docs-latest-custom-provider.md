...
- [Example Extensions](https://pi.dev/docs/latest/custom-provider#example-extensions)
- [Quick Reference](https://pi.dev/docs/latest/custom-provider#quick-reference)
- [Override Existing Provider](https://pi.dev/docs/latest/custom-provider#override-existing-provider)
- [Register New Provider](https://pi.dev/docs/latest/custom-provider#register-new-provider)
- [Unregister Provider](https://pi.dev/docs/latest/custom-provider#unregister-provider)
- [OAuth Support](https://pi.dev/docs/latest/custom-provider#oauth-support)
- [Custom Streaming API](https://pi.dev/docs/latest/custom-provider#custom-streaming-api)
- [Context Overflow Errors](https://pi.dev/docs/latest/custom-provider#context-overflow-errors)
- [Testing Your Implementation](https://pi.dev/docs/latest/custom-provider#testing-your-implementation)
- [Config Reference](https://pi.dev/docs/latest/custom-provider#config-reference)
- [Model Definition Reference](https://pi.dev/docs/latest/custom-provider#model-definition-reference)
