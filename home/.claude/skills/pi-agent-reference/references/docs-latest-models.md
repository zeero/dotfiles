...
- [Minimal Example](https://pi.dev/docs/latest/models#minimal-example)
- [Full Example](https://pi.dev/docs/latest/models#full-example)
- [Supported APIs](https://pi.dev/docs/latest/models#supported-apis)
- [Provider Configuration](https://pi.dev/docs/latest/models#provider-configuration)
- [Model Configuration](https://pi.dev/docs/latest/models#model-configuration)
- [Overriding Built-in Providers](https://pi.dev/docs/latest/models#overriding-built-in-providers)
- [Per-model Overrides](https://pi.dev/docs/latest/models#per-model-overrides)
- [Anthropic Messages Compatibility](https://pi.dev/docs/latest/models#anthropic-messages-compatibility)
- [OpenAI Compatibility](https://pi.dev/docs/latest/models#openai-compatibility)
