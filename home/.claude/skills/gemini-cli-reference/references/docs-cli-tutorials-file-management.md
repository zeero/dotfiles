[Skip to content](https://geminicli.com/docs/cli/tutorials/file-management/#_top)
...
[Section titled “Prerequisites”](https://geminicli.com/docs/cli/tutorials/file-management/#prerequisites)
...
[Section titled “Providing context by reading files”](https://geminicli.com/docs/cli/tutorials/file-management/#providing-context-by-reading-files)
...
[Section titled “Direct file inclusion (@)”](https://geminicli.com/docs/cli/tutorials/file-management/#direct-file-inclusion)
...
[Section titled “Working with multiple files”](https://geminicli.com/docs/cli/tutorials/file-management/#working-with-multiple-files)
...
[Section titled “Including entire directories”](https://geminicli.com/docs/cli/tutorials/file-management/#including-entire-directories)
...
[Section titled “How to find files (Exploration)”](https://geminicli.com/docs/cli/tutorials/file-management/#how-to-find-files-exploration)
...
[Section titled “Scenario: Find a component definition”](https://geminicli.com/docs/cli/tutorials/file-management/#scenario-find-a-component-definition)
...
[Section titled “How to modify code”](https://geminicli.com/docs/cli/tutorials/file-management/#how-to-modify-code)
...
[Section titled “Creating new files”](https://geminicli.com/docs/cli/tutorials/file-management/#creating-new-files)
...
[Section titled “Review and confirm changes”](https://geminicli.com/docs/cli/tutorials/file-management/#review-and-confirm-changes)
...
[Section titled “Verify the result”](https://geminicli.com/docs/cli/tutorials/file-management/#verify-the-result)
...
[Section titled “Advanced: Controlling what Gemini sees”](https://geminicli.com/docs/cli/tutorials/file-management/#advanced-controlling-what-gemini-sees)
...
[Section titled “Next steps”](https://geminicli.com/docs/cli/tutorials/file-management/#next-steps)

- Learn how to [Manage context and memory](https://geminicli.com/docs/cli/tutorials/memory-management) to keep your
agent smarter over long sessions.
- See [Execute shell commands](https://geminicli.com/docs/cli/tutorials/shell-commands) for more on running tests and
builds.
- Explore the technical [File system reference](https://geminicli.com/docs/tools/file-system) for
