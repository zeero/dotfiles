[Skip to content](https://geminicli.com/docs/release-confidence/#_top)
...
[Section titled “The goal”](https://geminicli.com/docs/release-confidence/#the-goal)
...
[Section titled “Level 1: Automated gates (must pass)”](https://geminicli.com/docs/release-confidence/#level-1-automated-gates-must-pass)
...
[Section titled “1. CI/CD health”](https://geminicli.com/docs/release-confidence/#1-cicd-health)
...
[Section titled “2. End-to-end (E2E) tests”](https://geminicli.com/docs/release-confidence/#2-end-to-end-e2e-tests)
...
[Section titled “3. Post-deployment smoke tests”](https://geminicli.com/docs/release-confidence/#3-post-deployment-smoke-tests)
...
[Section titled “Level 2: Manual verification and dogfooding”](https://geminicli.com/docs/release-confidence/#level-2-manual-verification-and-dogfooding)

Automated tests cannot catch everything, especially UX issues.

### 1\. Dogfooding via `preview` tag

[Section titled “1. Dogfooding via preview tag”](https://geminicli.com/docs/release-confidence/#1-dogfooding-via-preview-tag)
...
[Section titled “2. Critical user journey (CUJ) checklist”](https://geminicli.com/docs/release-confidence/#2-critical-user-journey-cuj-checklist)
...
[Section titled “3. Pre-Launch bug bash (tier 1 and 2 launches)”](https://geminicli.com/docs/release-confidence/#3-pre-launch-bug-bash-tier-1-and-2-launches)
...
[Section titled “Level 3: Telemetry and data review”](https://geminicli.com/docs/release-confidence/#level-3-telemetry-and-data-review)

### Dashboard health

[Section titled “Dashboard health”](https://geminicli.com/docs/release-confidence/#dashboard-health)
...
[Section titled “Model evaluation”](https://geminicli.com/docs/release-confidence/#model-evaluation)
...
[Section titled “The “go/no-go” decision”](https://geminicli.com/docs/release-confidence/#the-gono-go-decision)
