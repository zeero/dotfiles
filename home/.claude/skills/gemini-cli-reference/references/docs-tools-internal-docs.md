[Skip to content](https://geminicli.com/docs/tools/internal-docs/#_top)
...
[Section titled “Description”](https://geminicli.com/docs/tools/internal-docs/#description)
...
[Section titled “Arguments”](https://geminicli.com/docs/tools/internal-docs/#arguments)
...
[Section titled “Usage”](https://geminicli.com/docs/tools/internal-docs/#usage)
...
[Section titled “Behavior”](https://geminicli.com/docs/tools/internal-docs/#behavior)
...
[Section titled “Next steps”](https://geminicli.com/docs/tools/internal-docs/#next-steps)

- Explore the [Command reference](https://geminicli.com/docs/reference/commands) for a detailed guide
to slash commands.
- See the [Configuration guide](https://geminicli.com/docs/reference/configuration) for settings
reference.
