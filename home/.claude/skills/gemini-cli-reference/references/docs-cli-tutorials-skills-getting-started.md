[Skip to content](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#_top)
...
[Section titled “Create your first skill”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#create-your-first-skill)
...
[Section titled “1. Create the directory structure”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#1-create-the-directory-structure)
...
[Section titled “2. Create the definition (SKILL.md)”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#2-create-the-definition-skillmd)
...
[Section titled “3. Add the tool logic”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#3-add-the-tool-logic)
...
[Section titled “Verify discovery”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#verify-discovery)
...
[Section titled “If your skill doesn’t appear”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#if-your-skill-doesnt-appear)
...
[Section titled “How to use the skill”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#how-to-use-the-skill)
...
[Section titled “Pro tip: Use the skill-creator”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#pro-tip-use-the-skill-creator)
...
[Section titled “Manage skills”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#manage-skills)
...
[Section titled “Next steps”](https://geminicli.com/docs/cli/tutorials/skills-getting-started/#next-steps)

- [Creating Agent Skills](https://geminicli.com/docs/cli/creating-skills): Detailed guide on advanced
skill features and metadata.
- [Using Agent Skills](https://geminicli.com/docs/cli/using-agent-skills): More ways to discover and
manage your skill library.
- [Skill best practices](https://geminicli.com/docs/cli/skills-best-practices): Learn how to design
