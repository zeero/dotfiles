[Skip to content](https://geminicli.com/docs/cli/acp-mode/#_top)
...
[Section titled “Agent Client Protocol (ACP)”](https://geminicli.com/docs/cli/acp-mode/#agent-client-protocol-acp)
...
[Section titled “Existing integrations using ACP”](https://geminicli.com/docs/cli/acp-mode/#existing-integrations-using-acp)
...
[IDE Integration](https://geminicli.com/docs/ide-integration) documentation.
...
[Section titled “Architecture and protocol basics”](https://geminicli.com/docs/cli/acp-mode/#architecture-and-protocol-basics)
...
[Section titled “Extending with MCP”](https://geminicli.com/docs/cli/acp-mode/#extending-with-mcp)
...
[Section titled “Capabilities and supported methods”](https://geminicli.com/docs/cli/acp-mode/#capabilities-and-supported-methods)
...
[Section titled “Core methods”](https://geminicli.com/docs/cli/acp-mode/#core-methods)
...
[Section titled “Session control”](https://geminicli.com/docs/cli/acp-mode/#session-control)
...
[Section titled “File system proxy”](https://geminicli.com/docs/cli/acp-mode/#file-system-proxy)
...
[Section titled “Debugging and telemetry”](https://geminicli.com/docs/cli/acp-mode/#debugging-and-telemetry)
...
[Section titled “Debugging logs”](https://geminicli.com/docs/cli/acp-mode/#debugging-logs)
...
[Section titled “Telemetry”](https://geminicli.com/docs/cli/acp-mode/#telemetry)
