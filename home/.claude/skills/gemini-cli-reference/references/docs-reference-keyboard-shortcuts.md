[Skip to content](https://geminicli.com/docs/reference/keyboard-shortcuts/#_top)
...
[Section titled “Basic Controls”](https://geminicli.com/docs/reference/keyboard-shortcuts/#basic-controls)
...
#### Cursor Movement\
\
[Section titled “Cursor Movement”](https://geminicli.com/docs/reference/keyboard-shortcuts/#cursor-movement)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
#### Editing\
\
[Section titled “Editing”](https://geminicli.com/docs/reference/keyboard-shortcuts/#editing)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
#### Scrolling\
\
[Section titled “Scrolling”](https://geminicli.com/docs/reference/keyboard-shortcuts/#scrolling)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
#### History & Search\
\
[Section titled “History & Search”](https://geminicli.com/docs/reference/keyboard-shortcuts/#history--search)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
#### Navigation\
\
[Section titled “Navigation”](https://geminicli.com/docs/reference/keyboard-shortcuts/#navigation)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
\
[Section titled “Suggestions & Completions”](https://geminicli.com/docs/reference/keyboard-shortcuts/#suggestions--completions)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
#### Text Input\
\
[Section titled “Text Input”](https://geminicli.com/docs/reference/keyboard-shortcuts/#text-input)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
#### App Controls\
\
[Section titled “App Controls”](https://geminicli.com/docs/reference/keyboard-shortcuts/#app-controls)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
| `app.cycleApprovalMode` | Cycle through approval modes: default (prompt), auto\_edit (auto-approve edits), and plan (read-only). Plan mode is skipped when the agent is busy. | `Shift+Tab` |\
...
\
[Section titled “Background Shell Controls”](https://geminicli.com/docs/reference/keyboard-shortcuts/#background-shell-controls)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
#### Extension Controls\
\
[Section titled “Extension Controls”](https://geminicli.com/docs/reference/keyboard-shortcuts/#extension-controls)\
\
| Command | Action | Keys |\
| --- | --- | --- |\
...
\
[Section titled “Customizing Keybindings”](https://geminicli.com/docs/reference/keyboard-shortcuts/#customizing-keybindings)\
\
...
\
[Section titled “Configuration Format”](https://geminicli.com/docs/reference/keyboard-shortcuts/#configuration-format)\
\
...
\
[Section titled “Additional context-specific shortcuts”](https://geminicli.com/docs/reference/keyboard-shortcuts/#additional-context-specific-shortcuts)\
\
...
[collaboratively edit or comment](https://geminicli.com/docs/cli/plan-mode#collaborative-plan-editing)\
...
## Vi mode shortcuts\
\
[Section titled “Vi mode shortcuts”](https://geminicli.com/docs/reference/keyboard-shortcuts/#vi-mode-shortcuts)\
\
...
### Mode switching\
\
[Section titled “Mode switching”](https://geminicli.com/docs/reference/keyboard-shortcuts/#mode-switching)\
\
| Action | Keys |\
| --- | --- |\
...
\
[Section titled “Navigation in NORMAL mode”](https://geminicli.com/docs/reference/keyboard-shortcuts/#navigation-in-normal-mode)\
\
| Action | Keys |\
| --- | --- |\
| Move left | `h` |\
...
\
[Section titled “Editing in NORMAL mode”](https://geminicli.com/docs/reference/keyboard-shortcuts/#editing-in-normal-mode)\
\
| Action | Keys |\
| --- | --- |\
...
\
[Section titled “Find, replace, yank, and paste in NORMAL mode”](https://geminicli.com/docs/reference/keyboard-shortcuts/#find-replace-yank-and-paste-in-normal-mode)\
\
| Action | Keys |\
| --- | --- |\
...
## Limitations\
\
[Section titled “Limitations”](https://geminicli.com/docs/reference/keyboard-shortcuts/#limitations)\
\
- On [Windows Terminal](https://en.wikipedia.org/wiki/Windows_Terminal):\
\
  - `shift+enter` is only supported in version 1.25 and higher.\
  - `shift+tab` [is not supported](https://github.com/google-gemini/gemini-cli/issues/20314)\
