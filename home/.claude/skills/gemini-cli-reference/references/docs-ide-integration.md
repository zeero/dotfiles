[Skip to content](https://geminicli.com/docs/ide-integration/#_top)
...
[Section titled “VS Code companion extension”](https://geminicli.com/docs/ide-integration/#vs-code-companion-extension)
...
[Section titled “Features”](https://geminicli.com/docs/ide-integration/#features)
...
[Section titled “Installation and setup”](https://geminicli.com/docs/ide-integration/#installation-and-setup)

There are three ways to set up the IDE integration:

#### 1\. Automatic nudge (recommended)

[Section titled “1. Automatic nudge (recommended)”](https://geminicli.com/docs/ide-integration/#1-automatic-nudge-recommended)
...
[Section titled “2. Manual installation from CLI”](https://geminicli.com/docs/ide-integration/#2-manual-installation-from-cli)
...
[Section titled “3. Manual installation from a marketplace”](https://geminicli.com/docs/ide-integration/#3-manual-installation-from-a-marketplace)
...
[Section titled “Usage”](https://geminicli.com/docs/ide-integration/#usage)

#### Enabling and disabling

[Section titled “Enabling and disabling”](https://geminicli.com/docs/ide-integration/#enabling-and-disabling)
...
[Section titled “Checking the status”](https://geminicli.com/docs/ide-integration/#checking-the-status)
...
[Section titled “Working with diffs”](https://geminicli.com/docs/ide-integration/#working-with-diffs)
...
[Section titled “Agent Client Protocol (ACP)”](https://geminicli.com/docs/ide-integration/#agent-client-protocol-acp)
...
[Section titled “The ACP Agent Registry”](https://geminicli.com/docs/ide-integration/#the-acp-agent-registry)
...
[Section titled “IDE-specific integration”](https://geminicli.com/docs/ide-integration/#ide-specific-integration)
...
[Section titled “JetBrains IDEs”](https://geminicli.com/docs/ide-integration/#jetbrains-ides)
...
[Section titled “Zed”](https://geminicli.com/docs/ide-integration/#zed)
...
[Section titled “Other ACP-compatible IDEs”](https://geminicli.com/docs/ide-integration/#other-acp-compatible-ides)
...
[Section titled “Using with sandboxing”](https://geminicli.com/docs/ide-integration/#using-with-sandboxing)
...
[Section titled “Troubleshooting”](https://geminicli.com/docs/ide-integration/#troubleshooting)

### VS Code companion extension errors

[Section titled “VS Code companion extension errors”](https://geminicli.com/docs/ide-integration/#vs-code-companion-extension-errors)

#### Connection errors

[Section titled “Connection errors”](https://geminicli.com/docs/ide-integration/#connection-errors)
...
[Section titled “Manual PID override”](https://geminicli.com/docs/ide-integration/#manual-pid-override)
...
[Section titled “Configuration errors”](https://geminicli.com/docs/ide-integration/#configuration-errors)
...
[Section titled “General errors”](https://geminicli.com/docs/ide-integration/#general-errors)
...
- **Message:**`No installer is available for IDE. Please install Gemini CLI Companion extension manually from the marketplace.`
  ...
  - **Solution:** Open your IDE’s extension marketplace, search for “Gemini CLI
    Companion”, and
    [install it manually](https://geminicli.com/docs/ide-integration/#3-manual-installation-from-a-marketplace).

### ACP integration errors

[Section titled “ACP integration errors”](https://geminicli.com/docs/ide-integration/#acp-integration-errors)

For issues related to ACP integration, refer to the debugging and telemetry
section in the [ACP Mode](https://geminicli.com/docs/cli/acp-mode) documentation.
