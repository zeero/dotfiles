[Skip to content](https://geminicli.com/docs/tools/ask-user/#_top)
...
[Section titled “ask\_user (Ask User)”](https://geminicli.com/docs/tools/ask-user/#ask_user-ask-user)
...
[Section titled “Usage Examples”](https://geminicli.com/docs/tools/ask-user/#usage-examples)

### Multiple Choice Question

[Section titled “Multiple Choice Question”](https://geminicli.com/docs/tools/ask-user/#multiple-choice-question)
...
[Section titled “Text Input Question”](https://geminicli.com/docs/tools/ask-user/#text-input-question)
...
[Section titled “Yes/No Question”](https://geminicli.com/docs/tools/ask-user/#yesno-question)
