[Skip to content](https://geminicli.com/docs/contributing/#_top)
...
- **[Before you begin](https://geminicli.com/docs/contributing/#before-you-begin):** Essential steps to take before
becoming a Gemini CLI contributor.
- **[Code contribution process](https://geminicli.com/docs/contributing/#code-contribution-process):** How to contribute
code to Gemini CLI.
- **[Development setup and workflow](https://geminicli.com/docs/contributing/#development-setup-and-workflow):** How to
set up your development environment and workflow.
- **[Documentation contribution process](https://geminicli.com/docs/contributing/#documentation-contribution-process):**
...
[Section titled “Before you begin”](https://geminicli.com/docs/contributing/#before-you-begin)

### Sign our Contributor License Agreement

[Section titled “Sign our Contributor License Agreement”](https://geminicli.com/docs/contributing/#sign-our-contributor-license-agreement)
...
[Section titled “Review our Community Guidelines”](https://geminicli.com/docs/contributing/#review-our-community-guidelines)
...
[Section titled “Code contribution process”](https://geminicli.com/docs/contributing/#code-contribution-process)

### Get started

[Section titled “Get started”](https://geminicli.com/docs/contributing/#get-started)
...
[Section titled “Code reviews”](https://geminicli.com/docs/contributing/#code-reviews)
...
[Section titled “Using the automated review tool”](https://geminicli.com/docs/contributing/#using-the-automated-review-tool)
...
[Section titled “Self-assigning and unassigning issues”](https://geminicli.com/docs/contributing/#self-assigning-and-unassigning-issues)
...
[Section titled “Pull request guidelines”](https://geminicli.com/docs/contributing/#pull-request-guidelines)
...
[Section titled “1. Link to an existing issue”](https://geminicli.com/docs/contributing/#1-link-to-an-existing-issue)
...
[Section titled “2. Keep it small and focused”](https://geminicli.com/docs/contributing/#2-keep-it-small-and-focused)
...
[Section titled “3. Use draft PRs for work in progress”](https://geminicli.com/docs/contributing/#3-use-draft-prs-for-work-in-progress)
...
[Section titled “4. Ensure all checks pass”](https://geminicli.com/docs/contributing/#4-ensure-all-checks-pass)
...
[Section titled “5. Update documentation”](https://geminicli.com/docs/contributing/#5-update-documentation)
...
[Section titled “6. Write clear commit messages and a good PR description”](https://geminicli.com/docs/contributing/#6-write-clear-commit-messages-and-a-good-pr-description)
...
[Section titled “Forking”](https://geminicli.com/docs/contributing/#forking)
...
[Section titled “Development setup and workflow”](https://geminicli.com/docs/contributing/#development-setup-and-workflow)
...
[Section titled “Setting up the development environment”](https://geminicli.com/docs/contributing/#setting-up-the-development-environment)
...
[Section titled “Build process”](https://geminicli.com/docs/contributing/#build-process)
...
[Section titled “Enabling sandboxing”](https://geminicli.com/docs/contributing/#enabling-sandboxing)

[Sandboxing](https://geminicli.com/docs/contributing/#sandboxing) is highly recommended and requires, at a minimum,
...
[Sandboxing](https://geminicli.com/docs/contributing/#sandboxing) for details.
...
[Section titled “Running the CLI”](https://geminicli.com/docs/contributing/#running-the-cli)
...
[Section titled “Running tests”](https://geminicli.com/docs/contributing/#running-tests)

This project contains two types of tests: unit tests and integration tests.

#### Unit tests

[Section titled “Unit tests”](https://geminicli.com/docs/contributing/#unit-tests)
...
[Section titled “Integration tests”](https://geminicli.com/docs/contributing/#integration-tests)
...
[Section titled “Linting and preflight checks”](https://geminicli.com/docs/contributing/#linting-and-preflight-checks)
...
[Section titled “Formatting”](https://geminicli.com/docs/contributing/#formatting)
...
[Section titled “Linting”](https://geminicli.com/docs/contributing/#linting)
...
[Section titled “Coding conventions”](https://geminicli.com/docs/contributing/#coding-conventions)
...
[Section titled “Debugging”](https://geminicli.com/docs/contributing/#debugging)

#### VS Code

[Section titled “VS Code”](https://geminicli.com/docs/contributing/#vs-code)
...
[Section titled “React DevTools”](https://geminicli.com/docs/contributing/#react-devtools)
...
![](https://geminicli.com/docs/assets/connected_devtools.png)


### Sandboxing

[Section titled “Sandboxing”](https://geminicli.com/docs/contributing/#sandboxing)

#### macOS Seatbelt

[Section titled “macOS Seatbelt”](https://geminicli.com/docs/contributing/#macos-seatbelt)
...
[Section titled “Container-based sandboxing (all platforms)”](https://geminicli.com/docs/contributing/#container-based-sandboxing-all-platforms)
...
[Section titled “Proxied networking”](https://geminicli.com/docs/contributing/#proxied-networking)
...
[Section titled “Manual publish”](https://geminicli.com/docs/contributing/#manual-publish)
...
[Section titled “Documentation contribution process”](https://geminicli.com/docs/contributing/#documentation-contribution-process)
...
[Section titled “Getting started”](https://geminicli.com/docs/contributing/#getting-started)
...
[Section titled “Documentation structure”](https://geminicli.com/docs/contributing/#documentation-structure)
...
[Section titled “Style guide”](https://geminicli.com/docs/contributing/#style-guide)
...
[Section titled “Key style points”](https://geminicli.com/docs/contributing/#key-style-points)
...
[Section titled “Linting and formatting”](https://geminicli.com/docs/contributing/#linting-and-formatting)
...
[Section titled “Before you submit”](https://geminicli.com/docs/contributing/#before-you-submit)
...
[Section titled “Need help?”](https://geminicli.com/docs/contributing/#need-help)
