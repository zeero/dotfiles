[Skip to content](https://geminicli.com/docs/cli/auto-memory/#_top)
...
[Agent Skills](https://geminicli.com/docs/cli/skills). You review each candidate before it becomes
available to future sessions: apply memory updates, promote skills, or discard
anything you do not want.

## Overview

[Section titled “Overview”](https://geminicli.com/docs/cli/auto-memory/#overview)
...
[Section titled “Prerequisites”](https://geminicli.com/docs/cli/auto-memory/#prerequisites)
...
[Section titled “How to enable Auto Memory”](https://geminicli.com/docs/cli/auto-memory/#how-to-enable-auto-memory)
...
[Section titled “How Auto Memory works”](https://geminicli.com/docs/cli/auto-memory/#how-auto-memory-works)
...
[Section titled “How to review extracted items”](https://geminicli.com/docs/cli/auto-memory/#how-to-review-extracted-items)
...
[skill discovery precedence](https://geminicli.com/docs/cli/skills#skill-discovery-tiers). Applied memory
patches update the underlying memory files and reload memory for the current
session.

## How to disable Auto Memory

[Section titled “How to disable Auto Memory”](https://geminicli.com/docs/cli/auto-memory/#how-to-disable-auto-memory)
...
[Section titled “Data and privacy”](https://geminicli.com/docs/cli/auto-memory/#data-and-privacy)
...
[Section titled “Limitations”](https://geminicli.com/docs/cli/auto-memory/#limitations)
...
[Section titled “Next steps”](https://geminicli.com/docs/cli/auto-memory/#next-steps)

- Learn how skills are discovered and activated in [Agent Skills](https://geminicli.com/docs/cli/skills).
- Explore the [memory management tutorial](https://geminicli.com/docs/cli/tutorials/memory-management) for
the complementary explicit-memory and `GEMINI.md` workflows.
- Review the experimental settings catalog in
[Settings](https://geminicli.com/docs/cli/settings#experimental).
