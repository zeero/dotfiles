[Skip to content](https://geminicli.com/docs/cli/enterprise/#_top)
...
[Section titled “Centralized configuration: The system settings file”](https://geminicli.com/docs/cli/enterprise/#centralized-configuration-the-system-settings-file)
...
the [Configuration documentation](https://geminicli.com/docs/reference/configuration).
...
[Section titled “Enforcing system settings with a wrapper script”](https://geminicli.com/docs/cli/enterprise/#enforcing-system-settings-with-a-wrapper-script)
...
[Section titled “User isolation in shared environments”](https://geminicli.com/docs/cli/enterprise/#user-isolation-in-shared-environments)
...
[Section titled “Restricting tool access”](https://geminicli.com/docs/cli/enterprise/#restricting-tool-access)

You can significantly enhance security by controlling which tools the Gemini
model can use. This is achieved through the `tools.core` setting and the
[Policy Engine](https://geminicli.com/docs/reference/policy-engine). For a list of available tools,
see the [Tools reference](https://geminicli.com/docs/reference/tools).

### Allowlisting with `coreTools`

[Section titled “Allowlisting with coreTools”](https://geminicli.com/docs/cli/enterprise/#allowlisting-with-coretools)
...
[Section titled “Blocklisting with excludeTools (Deprecated)”](https://geminicli.com/docs/cli/enterprise/#blocklisting-with-excludetools-deprecated)

> **Deprecated:** Use the [Policy Engine](https://geminicli.com/docs/reference/policy-engine) for
> more robust control.
...
[Section titled “Disabling YOLO mode”](https://geminicli.com/docs/cli/enterprise/#disabling-yolo-mode)
...
[Section titled “Managing custom tools (MCP servers)”](https://geminicli.com/docs/cli/enterprise/#managing-custom-tools-mcp-servers)

If your organization uses custom tools via
[Model-Context Protocol (MCP) servers](https://geminicli.com/docs/tools/mcp-server), it is crucial to
understand how server configurations are managed to apply security policies
effectively.

### How MCP server configurations are merged

[Section titled “How MCP server configurations are merged”](https://geminicli.com/docs/cli/enterprise/#how-mcp-server-configurations-are-merged)
...
[Section titled “Enforcing a catalog of tools”](https://geminicli.com/docs/cli/enterprise/#enforcing-a-catalog-of-tools)
...
[Section titled “Restricting tools within an MCP server”](https://geminicli.com/docs/cli/enterprise/#restricting-tools-within-an-mcp-server)
...
[Section titled “More secure pattern: Define and add to allowlist in system settings”](https://geminicli.com/docs/cli/enterprise/#more-secure-pattern-define-and-add-to-allowlist-in-system-settings)
...
[Section titled “Less secure pattern: Omitting the allowlist”](https://geminicli.com/docs/cli/enterprise/#less-secure-pattern-omitting-the-allowlist)
...
[Section titled “Enforcing sandboxing for security”](https://geminicli.com/docs/cli/enterprise/#enforcing-sandboxing-for-security)
...
[Section titled “Controlling network access via proxy”](https://geminicli.com/docs/cli/enterprise/#controlling-network-access-via-proxy)
...
[Section titled “Telemetry and auditing”](https://geminicli.com/docs/cli/enterprise/#telemetry-and-auditing)
...
events. For more information, see the [telemetry documentation](https://geminicli.com/docs/cli/telemetry).
...
[Section titled “Authentication”](https://geminicli.com/docs/cli/enterprise/#authentication)
...
[Authentication docs](https://geminicli.com/docs/get-started/authentication) for more details.
...
[Section titled “Restricting logins to corporate domains”](https://geminicli.com/docs/cli/enterprise/#restricting-logins-to-corporate-domains)
...
[Section titled “Putting it all together: example system settings.json”](https://geminicli.com/docs/cli/enterprise/#putting-it-all-together-example-system-settingsjson)
