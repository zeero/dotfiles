[Skip to content](https://geminicli.com/docs/cli/model/#_top)
...
[Section titled “How to use the /model command”](https://geminicli.com/docs/cli/model/#how-to-use-the-model-command)
...
[configuration documentation](https://geminicli.com/docs/reference/configuration).
...
[Section titled “Best practices for model selection”](https://geminicli.com/docs/cli/model/#best-practices-for-model-selection)
