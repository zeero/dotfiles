[Skip to content](https://geminicli.com/docs/cli/creating-skills/#_top)
...
[Section titled “Quickstart: Create a skill with a prompt”](https://geminicli.com/docs/cli/creating-skills/#quickstart-create-a-skill-with-a-prompt)
...
[Section titled “Manual creation”](https://geminicli.com/docs/cli/creating-skills/#manual-creation)
...
[Section titled “1. Create the directory structure”](https://geminicli.com/docs/cli/creating-skills/#1-create-the-directory-structure)
...
[Section titled “2. Define the skill (SKILL.md)”](https://geminicli.com/docs/cli/creating-skills/#2-define-the-skill-skillmd)
...
[Section titled “3. Add the tool logic”](https://geminicli.com/docs/cli/creating-skills/#3-add-the-tool-logic)
...
[Section titled “4. Test the skill”](https://geminicli.com/docs/cli/creating-skills/#4-test-the-skill)
...
[Section titled “5. Optional: Share your skill”](https://geminicli.com/docs/cli/creating-skills/#5-optional-share-your-skill)
...
[Gemini CLI extension](https://geminicli.com/docs/extensions/writing-extensions).
...
[Section titled “Core concepts”](https://geminicli.com/docs/cli/creating-skills/#core-concepts)
...
[Section titled “Skill structure”](https://geminicli.com/docs/cli/creating-skills/#skill-structure)
...
[Section titled “Metadata and triggers”](https://geminicli.com/docs/cli/creating-skills/#metadata-and-triggers)
...
[Section titled “Discovery tiers”](https://geminicli.com/docs/cli/creating-skills/#discovery-tiers)
...
[Section titled “Discovery aliases”](https://geminicli.com/docs/cli/creating-skills/#discovery-aliases)
...
[Section titled “Advanced development”](https://geminicli.com/docs/cli/creating-skills/#advanced-development)
...
[Section titled “Creation scripts”](https://geminicli.com/docs/cli/creating-skills/#creation-scripts)
...
[Section titled “Linking for local development”](https://geminicli.com/docs/cli/creating-skills/#linking-for-local-development)
...
[Section titled “Next steps”](https://geminicli.com/docs/cli/creating-skills/#next-steps)

- [Skill best practices](https://geminicli.com/docs/cli/skills-best-practices): Learn strategies for
building reliable and effective skills.
- [Agent Skills overview](https://geminicli.com/docs/cli/skills): Deep dive into discovery tiers and the
skill lifecycle.
