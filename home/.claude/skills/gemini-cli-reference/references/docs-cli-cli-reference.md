[Skip to content](https://geminicli.com/docs/cli/cli-reference/#_top)
...
[Section titled “CLI commands”](https://geminicli.com/docs/cli/cli-reference/#cli-commands)
...
[Section titled “Positional arguments”](https://geminicli.com/docs/cli/cli-reference/#positional-arguments)
...
[Section titled “Interactive commands”](https://geminicli.com/docs/cli/cli-reference/#interactive-commands)
...
[Section titled “CLI Options”](https://geminicli.com/docs/cli/cli-reference/#cli-options)
...
| `--model` | `-m` | string | `auto` | Model to use. See [Model Selection](https://geminicli.com/docs/cli/cli-reference/#model-selection) for available values. |
...
| `--allowed-tools` | - | array | - | **Deprecated.** Use the [Policy Engine](https://geminicli.com/docs/reference/policy-engine) instead. Tools that are allowed to run without confirmation (comma-separated or multiple flags) |
...
[Section titled “Model selection”](https://geminicli.com/docs/cli/cli-reference/#model-selection)
...
[Section titled “Model aliases”](https://geminicli.com/docs/cli/cli-reference/#model-aliases)
...
[Section titled “Extensions management”](https://geminicli.com/docs/cli/cli-reference/#extensions-management)
...
See [Extensions Documentation](https://geminicli.com/docs/extensions) for more details.

## MCP server management

[Section titled “MCP server management”](https://geminicli.com/docs/cli/cli-reference/#mcp-server-management)
...
See [MCP Server Integration](https://geminicli.com/docs/tools/mcp-server) for more details.

## Skills management

[Section titled “Skills management”](https://geminicli.com/docs/cli/cli-reference/#skills-management)
...
See [Agent Skills Documentation](https://geminicli.com/docs/cli/skills) for more details.
