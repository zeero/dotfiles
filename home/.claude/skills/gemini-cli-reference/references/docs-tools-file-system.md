[Skip to content](https://geminicli.com/docs/tools/file-system/#_top)
...
[Section titled “Technical reference”](https://geminicli.com/docs/tools/file-system/#technical-reference)
...
[Section titled “list\_directory (ReadFolder)”](https://geminicli.com/docs/tools/file-system/#list_directory-readfolder)
...
[Section titled “read\_file (ReadFile)”](https://geminicli.com/docs/tools/file-system/#read_file-readfile)
...
[Section titled “write\_file (WriteFile)”](https://geminicli.com/docs/tools/file-system/#write_file-writefile)
...
[Section titled “glob (FindFiles)”](https://geminicli.com/docs/tools/file-system/#glob-findfiles)
...
[Section titled “grep\_search (SearchText)”](https://geminicli.com/docs/tools/file-system/#grep_search-searchtext)
...
[Section titled “replace (Edit)”](https://geminicli.com/docs/tools/file-system/#replace-edit)
...
[Section titled “Next steps”](https://geminicli.com/docs/tools/file-system/#next-steps)

- Follow the [File management tutorial](https://geminicli.com/docs/cli/tutorials/file-management) for
practical examples.
- Learn about [Trusted folders](https://geminicli.com/docs/cli/trusted-folders) to manage access
permissions.
