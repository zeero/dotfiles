...
[Tools reference](https://geminicli.com/docs/reference/tools#available-tools).
...
[Section titled “Special syntax for run\_shell\_command”](https://geminicli.com/docs/reference/policy-engine/#special-syntax-for-run_shell_command)
...
itself. For the tool’s invocation arguments, see [Shell tool](https://geminicli.com/docs/tools/shell)
and [Tools reference](https://geminicli.com/docs/reference/tools#available-tools).
...
[Section titled “Special syntax for subagents”](https://geminicli.com/docs/reference/policy-engine/#special-syntax-for-subagents)
