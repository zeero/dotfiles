[Skip to content](https://geminicli.com/docs/resources/tos-privacy/#_top)
...
[Section titled “Supported authentication methods”](https://geminicli.com/docs/resources/tos-privacy/#supported-authentication-methods)
...
[Section titled “1. If you have signed in with your Google account to Gemini Code Assist”](https://geminicli.com/docs/resources/tos-privacy/#1-if-you-have-signed-in-with-your-google-account-to-gemini-code-assist)
...
[Section titled “2. If you have signed in with a Gemini API key to the Gemini Developer API”](https://geminicli.com/docs/resources/tos-privacy/#2-if-you-have-signed-in-with-a-gemini-api-key-to-the-gemini-developer-api)
...
[Section titled “3. If you have signed in with a Gemini API key to the Vertex AI GenAI API”](https://geminicli.com/docs/resources/tos-privacy/#3-if-you-have-signed-in-with-a-gemini-api-key-to-the-vertex-ai-genai-api)
...
[Section titled “Usage statistics opt-out”](https://geminicli.com/docs/resources/tos-privacy/#usage-statistics-opt-out)
