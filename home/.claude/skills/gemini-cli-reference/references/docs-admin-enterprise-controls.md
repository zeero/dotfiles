[Skip to content](https://geminicli.com/docs/admin/enterprise-controls/#_top)
...
[Section titled “Admin Controls vs. System Settings”](https://geminicli.com/docs/admin/enterprise-controls/#admin-controls-vs-system-settings)

While [System-wide settings](https://geminicli.com/docs/cli/settings) act as convenient configuration
...
[Section titled “Available Controls”](https://geminicli.com/docs/admin/enterprise-controls/#available-controls)

### Strict Mode

[Section titled “Strict Mode”](https://geminicli.com/docs/admin/enterprise-controls/#strict-mode)
...
[Section titled “Extensions”](https://geminicli.com/docs/admin/enterprise-controls/#extensions)

**Enabled/Disabled** \| Default: disabled

If disabled, users will not be able to use or install extensions. See
[Extensions](https://geminicli.com/docs/extensions) for more details.

### MCP

[Section titled “MCP”](https://geminicli.com/docs/admin/enterprise-controls/#mcp)

#### Enabled/Disabled

[Section titled “Enabled/Disabled”](https://geminicli.com/docs/admin/enterprise-controls/#enableddisabled)

**Enabled/Disabled** \| Default: disabled

If disabled, users will not be able to use MCP servers. See
[MCP Server Integration](https://geminicli.com/docs/tools/mcp-server) for more details.

#### MCP Servers (preview)

[Section titled “MCP Servers (preview)”](https://geminicli.com/docs/admin/enterprise-controls/#mcp-servers-preview)
...
[Section titled “Required MCP Servers (preview)”](https://geminicli.com/docs/admin/enterprise-controls/#required-mcp-servers-preview)
...
[Section titled “Unmanaged Capabilities”](https://geminicli.com/docs/admin/enterprise-controls/#unmanaged-capabilities)

**Enabled/Disabled** \| Default: disabled

If disabled, users will not be able to use certain features. Currently, this
control disables Agent Skills. See [Agent Skills](https://geminicli.com/docs/cli/skills) for more
details.
