[Skip to content](https://geminicli.com/docs/releases/#_top)
...
[Section titled “dev vs prod environment”](https://geminicli.com/docs/releases/#dev-vs-prod-environment)
...
[Section titled “Package scopes”](https://geminicli.com/docs/releases/#package-scopes)
...
[Section titled “Release cadence and tags”](https://geminicli.com/docs/releases/#release-cadence-and-tags)
...
[Section titled “Preview”](https://geminicli.com/docs/releases/#preview)
...
[Section titled “Stable”](https://geminicli.com/docs/releases/#stable)
...
[Section titled “Nightly”](https://geminicli.com/docs/releases/#nightly)
...
[Section titled “Weekly release promotion”](https://geminicli.com/docs/releases/#weekly-release-promotion)
...
[Section titled “Source of truth for versioning”](https://geminicli.com/docs/releases/#source-of-truth-for-versioning)
...
[Section titled “Manual releases”](https://geminicli.com/docs/releases/#manual-releases)
...
[Section titled “How to create a manual release”](https://geminicli.com/docs/releases/#how-to-create-a-manual-release)
...
[Section titled “Rollback/rollforward”](https://geminicli.com/docs/releases/#rollbackrollforward)
...
[Section titled “How to change a release tag”](https://geminicli.com/docs/releases/#how-to-change-a-release-tag)
...
[Section titled “Patching”](https://geminicli.com/docs/releases/#patching)
...
[Section titled “How to patch”](https://geminicli.com/docs/releases/#how-to-patch)

#### 1\. Create the patch pull request

[Section titled “1. Create the patch pull request”](https://geminicli.com/docs/releases/#1-create-the-patch-pull-request)
...
[Section titled “2. Review and merge”](https://geminicli.com/docs/releases/#2-review-and-merge)
...
[Section titled “2.5. Adding multiple commits to a hotfix (advanced)”](https://geminicli.com/docs/releases/#25-adding-multiple-commits-to-a-hotfix-advanced)
...
[Section titled “3. Automatic release”](https://geminicli.com/docs/releases/#3-automatic-release)
...
[Section titled “Troubleshooting: Older branch workflows”](https://geminicli.com/docs/releases/#troubleshooting-older-branch-workflows)
...
[Section titled “Docker”](https://geminicli.com/docs/releases/#docker)
...
[Section titled “Release validation”](https://geminicli.com/docs/releases/#release-validation)
...
[Section titled “Local testing and validation: Changes to the packaging and publishing process”](https://geminicli.com/docs/releases/#local-testing-and-validation-changes-to-the-packaging-and-publishing-process)
...
[Section titled “Release deep dive”](https://geminicli.com/docs/releases/#release-deep-dive)
...
[Section titled “Notifications”](https://geminicli.com/docs/releases/#notifications)
...
[Section titled “Modifying chat notifications”](https://geminicli.com/docs/releases/#modifying-chat-notifications)
