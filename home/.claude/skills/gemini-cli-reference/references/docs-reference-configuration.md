[Skip to content](https://geminicli.com/docs/reference/configuration/#_top)
...
[Section titled “Configuration layers”](https://geminicli.com/docs/reference/configuration/#configuration-layers)
...
[Section titled “Settings files”](https://geminicli.com/docs/reference/configuration/#settings-files)
...
[Enterprise Configuration](https://geminicli.com/docs/cli/enterprise) documentation.

### The `.gemini` directory in your project

[Section titled “The .gemini directory in your project”](https://geminicli.com/docs/reference/configuration/#the-gemini-directory-in-your-project)

In addition to a project settings file, a project’s `.gemini` directory can
contain other project-specific files related to Gemini CLI’s operation, such as:

- [Custom sandbox profiles](https://geminicli.com/docs/reference/configuration/#sandboxing) (for example,
`.gemini/sandbox-macos-custom.sb`, `.gemini/sandbox.Dockerfile`).

### Available settings in `settings.json`

[Section titled “Available settings in settings.json”](https://geminicli.com/docs/reference/configuration/#available-settings-in-settingsjson)
...
[Section titled “policyPaths”](https://geminicli.com/docs/reference/configuration/#policypaths)
...
[Section titled “adminPolicyPaths”](https://geminicli.com/docs/reference/configuration/#adminpolicypaths)
...
[Section titled “general”](https://geminicli.com/docs/reference/configuration/#general)
...
[Section titled “output”](https://geminicli.com/docs/reference/configuration/#output)
...
[Section titled “ui”](https://geminicli.com/docs/reference/configuration/#ui)
...
[Section titled “ide”](https://geminicli.com/docs/reference/configuration/#ide)
...
[Section titled “privacy”](https://geminicli.com/docs/reference/configuration/#privacy)
...
[Section titled “billing”](https://geminicli.com/docs/reference/configuration/#billing)
...
[Section titled “model”](https://geminicli.com/docs/reference/configuration/#model)
...
[Section titled “modelConfigs”](https://geminicli.com/docs/reference/configuration/#modelconfigs)
...
[Section titled “agents”](https://geminicli.com/docs/reference/configuration/#agents)
...
- **`agents.browser.visualModel`** (string):
  - **Description:** Model for the visual agent’s analyze\_screenshot tool. When
...
- **`agents.browser.confirmSensitiveActions`** (boolean):
  - **Description:** Require manual confirmation for sensitive browser actions
    (e.g., fill\_form, evaluate\_script).
  - **Default:**`false`
  - **Requires restart:** Yes
...
[Section titled “context”](https://geminicli.com/docs/reference/configuration/#context)
...
[Section titled “tools”](https://geminicli.com/docs/reference/configuration/#tools)
...
[Section titled “mcp”](https://geminicli.com/docs/reference/configuration/#mcp)
...
[Section titled “useWriteTodos”](https://geminicli.com/docs/reference/configuration/#usewritetodos)
...
[Section titled “security”](https://geminicli.com/docs/reference/configuration/#security)
...
[Section titled “advanced”](https://geminicli.com/docs/reference/configuration/#advanced)
...
[Section titled “experimental”](https://geminicli.com/docs/reference/configuration/#experimental)
...
- **`experimental.memoryV2`** (boolean):
  - **Description:** Disable the built-in save\_memory tool and let the main
    agent persist project context by editing markdown files directly with
    edit/write\_file. Route facts across four tiers: team-shared conventions go
    ...
    to the legacy save\_memory tool.
  - **Default:**`true`
  - **Requires restart:** Yes
...
[Section titled “skills”](https://geminicli.com/docs/reference/configuration/#skills)
...
[Section titled “hooksConfig”](https://geminicli.com/docs/reference/configuration/#hooksconfig)
...
[Section titled “hooks”](https://geminicli.com/docs/reference/configuration/#hooks)
...
[Section titled “contextManagement”](https://geminicli.com/docs/reference/configuration/#contextmanagement)
...
[Section titled “admin”](https://geminicli.com/docs/reference/configuration/#admin)
...
[Section titled “mcpServers”](https://geminicli.com/docs/reference/configuration/#mcpservers)
...
[Section titled “telemetry”](https://geminicli.com/docs/reference/configuration/#telemetry)

Configures logging and metrics collection for Gemini CLI. For more information,
see [Telemetry](https://geminicli.com/docs/cli/telemetry).
...
[Section titled “Example settings.json”](https://geminicli.com/docs/reference/configuration/#example-settingsjson)
...
[Section titled “Shell history”](https://geminicli.com/docs/reference/configuration/#shell-history)
...
[Section titled “Environment variables and .env files”](https://geminicli.com/docs/reference/configuration/#environment-variables-and-env-files)

Environment variables are a common way to configure applications, especially for
sensitive information like API keys or for settings that might change between
environments. For authentication setup, see the
[Authentication documentation](https://geminicli.com/docs/get-started/authentication) which covers
...
- **`GEMINI_API_KEY`**:
  ...
  - One of several available
    [authentication methods](https://geminicli.com/docs/get-started/authentication).
...
[Section titled “Environment variable redaction”](https://geminicli.com/docs/reference/configuration/#environment-variable-redaction)
...
[Section titled “Command-line arguments”](https://geminicli.com/docs/reference/configuration/#command-line-arguments)
...
[Section titled “Context files (hierarchical instructional context)”](https://geminicli.com/docs/reference/configuration/#context-files-hierarchical-instructional-context)
...
[Section titled “Example context file content (for example, GEMINI.md)”](https://geminicli.com/docs/reference/configuration/#example-context-file-content-for-example-geminimd)
...
see the [Memory Import Processor documentation](https://geminicli.com/docs/reference/memport).
- **Commands for memory management:**
  ...
  - Use `/memory show` to display the combined instructional context currently
    ...
    AI.
  - See the [Commands documentation](https://geminicli.com/docs/reference/commands#memory) for full details on
...
[Section titled “Sandboxing”](https://geminicli.com/docs/reference/configuration/#sandboxing)
...
[Section titled “Usage statistics”](https://geminicli.com/docs/reference/configuration/#usage-statistics)
