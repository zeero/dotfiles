[Skip to content](https://geminicli.com/docs/cli/system-prompt/#_top)
...
[Section titled “Overview”](https://geminicli.com/docs/cli/system-prompt/#overview)
...
[Section titled “How to enable”](https://geminicli.com/docs/cli/system-prompt/#how-to-enable)

You can set the environment variable temporarily in your shell, or persist it
via a `.gemini/.env` file. See
[Persisting Environment Variables](https://geminicli.com/docs/get-started/authentication#persisting-environment-variables).
...
[Section titled “Quick examples”](https://geminicli.com/docs/cli/system-prompt/#quick-examples)
...
[Section titled “UI indicator”](https://geminicli.com/docs/cli/system-prompt/#ui-indicator)
...
[Section titled “Variable Substitution”](https://geminicli.com/docs/cli/system-prompt/#variable-substitution)
...
[Section titled “Example”](https://geminicli.com/docs/cli/system-prompt/#example)
...
[Section titled “Export the default prompt (recommended)”](https://geminicli.com/docs/cli/system-prompt/#export-the-default-prompt-recommended)
...
[Section titled “Best practices: system.md vs GEMINI.md”](https://geminicli.com/docs/cli/system-prompt/#best-practices-systemmd-vs-geminimd)
...
[Section titled “Troubleshooting”](https://geminicli.com/docs/cli/system-prompt/#troubleshooting)
