[Skip to content](https://geminicli.com/docs/reference/commands/#_top)
...
[Section titled “Slash commands (/)”](https://geminicli.com/docs/reference/commands/#slash-commands)

Slash commands provide meta-level control over the CLI itself.

### Built-in Commands

[Section titled “Built-in Commands”](https://geminicli.com/docs/reference/commands/#built-in-commands)

### `/about`

[Section titled “/about”](https://geminicli.com/docs/reference/commands/#about)

- **Description:** Show version info. Share this information when filing issues.

### `/agents`

[Section titled “/agents”](https://geminicli.com/docs/reference/commands/#agents)
...
[Section titled “/auth”](https://geminicli.com/docs/reference/commands/#auth)

- **Description:** Open a dialog that lets you change the authentication method.

### `/bug`

[Section titled “/bug”](https://geminicli.com/docs/reference/commands/#bug)
...
[Section titled “/chat”](https://geminicli.com/docs/reference/commands/#chat)
  ...
  - **`save <tag>`**
    ...
    - **Details on checkpoint location:**The default locations for saved chat
      ...
      - **Note:** These checkpoints are for manually saving and resuming
        ...
        [Checkpointing documentation](https://geminicli.com/docs/cli/checkpointing).
...
[Section titled “/clear”](https://geminicli.com/docs/reference/commands/#clear)
...
[Section titled “/commands”](https://geminicli.com/docs/reference/commands/#commands)
...
[Section titled “/compress”](https://geminicli.com/docs/reference/commands/#compress)
...
[Section titled “/copy”](https://geminicli.com/docs/reference/commands/#copy)
...
[Section titled “/directory (or /dir)”](https://geminicli.com/docs/reference/commands/#directory-or-dir)
...
[Section titled “/docs”](https://geminicli.com/docs/reference/commands/#docs)

- **Description:** Open Gemini CLI documentation in your browser.

### `/editor`

[Section titled “/editor”](https://geminicli.com/docs/reference/commands/#editor)

- **Description:** Open a dialog for selecting supported editors.

### `/extensions`

[Section titled “/extensions”](https://geminicli.com/docs/reference/commands/#extensions)
...
[Section titled “/help (or /?)”](https://geminicli.com/docs/reference/commands/#help-or)
...
[Section titled “/hooks”](https://geminicli.com/docs/reference/commands/#hooks)
...
[Section titled “/ide”](https://geminicli.com/docs/reference/commands/#ide)
...
[Section titled “/init”](https://geminicli.com/docs/reference/commands/#init)
...
[Section titled “/mcp”](https://geminicli.com/docs/reference/commands/#mcp)
...
[Section titled “/memory”](https://geminicli.com/docs/reference/commands/#memory)
...
- **Sub-commands:**
  ...
  - **Note:** For more details on how `GEMINI.md` files contribute to
    ...
    [CLI Configuration documentation](https://geminicli.com/docs/reference/configuration).

### `/model`

[Section titled “/model”](https://geminicli.com/docs/reference/commands/#model)
...
[Section titled “/permissions”](https://geminicli.com/docs/reference/commands/#permissions)
...
[Section titled “/plan”](https://geminicli.com/docs/reference/commands/#plan)
...
[Section titled “/policies”](https://geminicli.com/docs/reference/commands/#policies)
...
[Section titled “/privacy”](https://geminicli.com/docs/reference/commands/#privacy)
...
[Section titled “/quit (or /exit)”](https://geminicli.com/docs/reference/commands/#quit-or-exit)
...
[Section titled “/restore”](https://geminicli.com/docs/reference/commands/#restore)
...
[settings](https://geminicli.com/docs/reference/configuration). See
[Checkpointing documentation](https://geminicli.com/docs/cli/checkpointing) for more details.

### `/rewind`

[Section titled “/rewind”](https://geminicli.com/docs/reference/commands/#rewind)
...
[Section titled “/resume”](https://geminicli.com/docs/reference/commands/#resume)
...
saving required. See [Session Management](https://geminicli.com/docs/cli/session-management) for
complete details.
...
[Section titled “/settings”](https://geminicli.com/docs/reference/commands/#settings)
...
[settings documentation](https://geminicli.com/docs/cli/settings) for a full list of available
settings.
...
[Section titled “/shells (or /bashes)”](https://geminicli.com/docs/reference/commands/#shells-or-bashes)
...
[Section titled “/setup-github”](https://geminicli.com/docs/reference/commands/#setup-github)
...
[Section titled “/skills”](https://geminicli.com/docs/reference/commands/#skills)
...
[Section titled “/stats”](https://geminicli.com/docs/reference/commands/#stats)
...
[Section titled “/terminal-setup”](https://geminicli.com/docs/reference/commands/#terminal-setup)
...
[Section titled “/theme”](https://geminicli.com/docs/reference/commands/#theme)
...
[Section titled “/tools”](https://geminicli.com/docs/reference/commands/#tools)
...
[Section titled “/upgrade”](https://geminicli.com/docs/reference/commands/#upgrade)
...
[Section titled “/vim”](https://geminicli.com/docs/reference/commands/#vim)
...
[Section titled “Custom commands”](https://geminicli.com/docs/reference/commands/#custom-commands)
...
the dedicated [Custom Commands documentation](https://geminicli.com/docs/cli/custom-commands).

## Input prompt shortcuts

[Section titled “Input prompt shortcuts”](https://geminicli.com/docs/reference/commands/#input-prompt-shortcuts)
...
[Section titled “At commands (@)”](https://geminicli.com/docs/reference/commands/#at-commands)
...
[Section titled “Error handling for @ commands”](https://geminicli.com/docs/reference/commands/#error-handling-for--commands)
...
[Section titled “Shell mode and passthrough commands (!)”](https://geminicli.com/docs/reference/commands/#shell-mode-and-passthrough-commands)
