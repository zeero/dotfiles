[Skip to content](https://geminicli.com/docs/cli/tutorials/shell-commands/#_top)
...
[Section titled “Prerequisites”](https://geminicli.com/docs/cli/tutorials/shell-commands/#prerequisites)
...
[Section titled “How to run commands directly (!)”](https://geminicli.com/docs/cli/tutorials/shell-commands/#how-to-run-commands-directly)
...
[Section titled “Scenario: Entering Shell mode”](https://geminicli.com/docs/cli/tutorials/shell-commands/#scenario-entering-shell-mode)
...
[Section titled “How to automate complex tasks”](https://geminicli.com/docs/cli/tutorials/shell-commands/#how-to-automate-complex-tasks)

You can automate tasks using a combination of Gemini CLI and shell commands.

### Scenario: Run tests and fix failures

[Section titled “Scenario: Run tests and fix failures”](https://geminicli.com/docs/cli/tutorials/shell-commands/#scenario-run-tests-and-fix-failures)

You want to run tests and fix any failures.

**Prompt:**`Run the unit tests. If any fail, analyze the error and try to fix the code.`
...
[Section titled “How to manage background processes”](https://geminicli.com/docs/cli/tutorials/shell-commands/#how-to-manage-background-processes)
...
[Section titled “Scenario: Viewing active shells”](https://geminicli.com/docs/cli/tutorials/shell-commands/#scenario-viewing-active-shells)
...
[Section titled “How to handle interactive commands”](https://geminicli.com/docs/cli/tutorials/shell-commands/#how-to-handle-interactive-commands)
...
[Section titled “Safety features”](https://geminicli.com/docs/cli/tutorials/shell-commands/#safety-features)
...
[Section titled “Confirmation prompts”](https://geminicli.com/docs/cli/tutorials/shell-commands/#confirmation-prompts)
...
[Section titled “Sandboxing”](https://geminicli.com/docs/cli/tutorials/shell-commands/#sandboxing)
...
[Section titled “Next steps”](https://geminicli.com/docs/cli/tutorials/shell-commands/#next-steps)

- Learn about [Sandboxing](https://geminicli.com/docs/cli/sandbox) to safely run destructive
commands.
- See the [Shell tool reference](https://geminicli.com/docs/tools/shell) for configuration options
like timeouts and working directories.
- Explore [Task planning](https://geminicli.com/docs/cli/tutorials/task-planning) to see how shell commands fit into
larger workflows.
